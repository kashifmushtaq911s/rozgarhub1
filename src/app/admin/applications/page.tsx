  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col gap-3">
        <h1 className="text-4xl font-black tracking-tight text-slate-900">Application <span className="text-indigo-600">Archive</span></h1>
      ...
      <Card className="rounded-[3rem] border-none shadow-2xl shadow-slate-200/50 bg-white overflow-hidden">
        ...
        <CardContent className="p-24 flex flex-col items-center justify-center text-center">
           ...
           <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600">Pending Integration</span>
           </div>
           ...
           <div className="h-1.5 w-48 bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full w-1/3 bg-gradient-to-r from-indigo-500 to-emerald-500 animate-[shimmer_2s_infinite]"></div>
           </div>
        </CardContent>
      </Card>
